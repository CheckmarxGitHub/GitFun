...
public class CWE80_XSS__Servlet_URLConnection_61a extends AbstractTestCaseServlet
{
    ...
    {
        String data = (new CWE80_XSS__Servlet_URLConnection_61b()).bad_source(request, response);
    ...
    {
        String data = (new CWE80_XSS__Servlet_URLConnection_61b()).goodG2B_source(request, response);
