...
public class CWE80_XSS__Servlet_URLConnection_67b
{
    ...
    public void bad_sink(CWE80_XSS__Servlet_URLConnection_67a.Container data_container , HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
    ...
    public void goodG2B_sink(CWE80_XSS__Servlet_URLConnection_67a.Container data_container , HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        String data = data_container.a;
