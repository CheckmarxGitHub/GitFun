...
public class CWE80_XSS__Servlet_connect_tcp_67a extends AbstractTestCaseServlet
{
    ...
    public void bad(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE80_XSS__Servlet_connect_tcp_67b()).bad_sink(data_container , request, response );
    }
    ...
    private void goodG2B(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        Container data_container = new Container();
        data_container.a = data;
        (new CWE80_XSS__Servlet_connect_tcp_67b()).goodG2B_sink(data_container , request, response );
    }
