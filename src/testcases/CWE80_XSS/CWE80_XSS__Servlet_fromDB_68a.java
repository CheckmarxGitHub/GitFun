...
Filename: CWE80_XSS__Servlet_fromDB_68a.java
...
public class CWE80_XSS__Servlet_fromDB_68a extends AbstractTestCaseServlet
{
    ...
    public void bad(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE80_XSS__Servlet_fromDB_68b()).bad_sink(request, response);
    }
    ...
    private void goodG2B(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE80_XSS__Servlet_fromDB_68b()).goodG2B_sink(request, response);
    }
