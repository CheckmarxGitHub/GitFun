...
Filename: CWE80_XSS__Servlet_getParameterServlet_68b.java
...
public class CWE80_XSS__Servlet_getParameterServlet_68b
{

    public void bad_sink(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        String data = CWE80_XSS__Servlet_getParameterServlet_68a.data;
