...
Filename: CWE80_XSS__Servlet_getQueryStringServlet_54a.java
...
public class CWE80_XSS__Servlet_getQueryStringServlet_54a extends AbstractTestCaseServlet
{
    ...
    public void bad(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE80_XSS__Servlet_getQueryStringServlet_54b()).bad_sink(data , request, response);
    }
    ...
    private void goodG2B(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE80_XSS__Servlet_getQueryStringServlet_54b()).goodG2B_sink(data , request, response);
    }
