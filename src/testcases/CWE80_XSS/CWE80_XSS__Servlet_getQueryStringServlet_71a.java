...
Filename: CWE80_XSS__Servlet_getQueryStringServlet_71a.java
...
public class CWE80_XSS__Servlet_getQueryStringServlet_71a extends AbstractTestCaseServlet
{
    ...
    public void bad(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE80_XSS__Servlet_getQueryStringServlet_71b()).bad_sink((Object)data , request, response );
    }
    ...
    private void goodG2B(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE80_XSS__Servlet_getQueryStringServlet_71b()).goodG2B_sink((Object)data , request, response );
    }
